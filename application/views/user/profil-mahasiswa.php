        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="<?= base_url('user/updateMahasiswa') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="nama_dosen" class="col-sm-2 col-form-label">Dosen Wali</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" value="<?= $mahasiswa['nama_dosen'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama_wali" class="col-sm-2 col-form-label">Orang Tua Wali</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="pekerjaan_wali" class="col-sm-2 col-form-label">Pekerjaan Orang Tua</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="asal_daerah" class="col-sm-2 col-form-label">Daerah Asal</label>
                        <div class="col-sm-10">
