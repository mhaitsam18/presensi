        	...
        	<div class="col-lg-8">
        		...
        		<form action="<?= base_url('user/keamanan') ?>" method="post" enctype="multipart/form-data">
        			<div class="form-group row">
        				<label for="id_pertanyaan_1" class="col-sm-2 col-form-label">Pertanyaan 1</label>
        				<div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="jawaban_1" class="col-sm-2 col-form-label">Jawaban</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="jawaban_2" class="col-sm-2 col-form-label">Jawaban</label>
                        <div class="col-sm-10">
